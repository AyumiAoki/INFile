        ...
        <div class="container">
            <div class="col-md-9 mx-auto py-3 px-4 bg-white shadow rounded">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6">
                        <a class="btn btn-warning text-white float-right" data-toggle="modal" data-target="#editar">Editar perfil <i class="fa fa-pen"></i></a>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-6 mb-3">
                        <a class="btn btn-success float-right text-white" href="cadastroProjeto.jsp">Criar projeto <i class="fa fa-plus"></i></a>
                    </div>
                </div>
                <div class="px-3">
                    <div class="card mb-3 shadow">
                        <div class="row no-gutters">
                            ...
                            <a href="publicacao.jsp" class="stretched-link"></a>
                        </div>
                    </div>
